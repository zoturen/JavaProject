...
public class MastermindGUI extends JFrame {
    ...
    private void initComponents() {
        ...
        button2.setIcon(new ImageIcon(getClass().getResource("../content/Dot_Black.png")));
        ...
        button3.setIcon(new ImageIcon(getClass().getResource("../content/Dot_White.png")));
        ...
        button4.setIcon(new ImageIcon(getClass().getResource("../content/Dot_Red.png")));
        ...
        button5.setIcon(new ImageIcon(getClass().getResource("../content/Dot_Purple.png")));
        ...
        button6.setIcon(new ImageIcon(getClass().getResource("../content/Dot_Green.png")));
        ...
        button7.setIcon(new ImageIcon(getClass().getResource("../content/Dot_Blue.png")));
